...
const SubmitButtonComponent = /** @class */ (function (_super) {
    ...
    function SubmitButtonComponent() {
        ...
        _this.isDisableButton = function () {
            const _a = _this.props, disabled = _a.disabled, isSending = _a.isSending;
            return disabled || isSending;
        };
        _this.handleSubmit = function (e) {
            const onSubmit = _this.props.onSubmit;
            if (onSubmit) {
                const _a = _this.props, formAlias = _a.formAlias, successNotification = _a.successNotification, errorNotification = _a.errorNotification, submitParams = _a.submitParams, redirectDelay = _a.redirectDelay, redirectUrl = _a.redirectUrl, actionUrl = _a.actionUrl, withoutSend = _a.withoutSend, withoutNotification = _a.withoutNotification, withoutRedirect = _a.withoutRedirect;
                e.preventDefault();
                const params = tslib_1.__assign({ formAlias: formAlias,
                    redirectDelay: redirectDelay,
                    redirectUrl: redirectUrl,
                    actionUrl: actionUrl,
                    withoutSend: withoutSend,
                    withoutNotification: withoutNotification,
                    withoutRedirect: withoutRedirect, notification: {
    ...
    SubmitButtonComponent.prototype.componentWillReceiveProps = function (newProps) {
        const status = this.props.status;
        if (newProps.status === FORM_STATUSES.SUBMIT_ERROR &&
            status !== FORM_STATUSES.SUBMIT_ERROR) {
            this.setShakeAnimate(true);
        }
    };
    SubmitButtonComponent.prototype.render = function () {
        const _a = this.props, title = _a.title, className = _a.className, children = _a.children, additionClassName = _a.additionClassName;
        const isShakeAnimate = this.state.isShakeAnimate;
        return (React.createElement("button", { type: "submit", className: className + " " + additionClassName + " " + (isShakeAnimate ? "animate-shake" : ""), onClick: this.handleSubmit, disabled: this.isDisableButton() }, children || title));
    };
